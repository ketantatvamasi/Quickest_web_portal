...
{{--        </li>--}}
        ...
        <li class="dropdown notification-list">
            <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false" title="Notifications">
                ...
                <div style="max-height: 230px;" data-simplebar="">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <div class="notify-icon">
                            <img src="{{Storage::url(Auth::user()->profile_icon)}}" class="img-fluid rounded-circle" alt="{{Auth::user()->name}}"> </div>
...
{{--        </li>--}}
        ...
        <li class="notification-list">
            <a class="nav-link end-bar-toggle" href="javascript: void(0);" title="Help & Support">
        ...
        <li class="dropdown notification-list">
            <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                    <span class="account-user-avatar">
                                         <img src="{{(Auth::user()->profile_icon)?Storage::url(Auth::user()->profile_icon):url('assets/images/users/avatar-1.jpg')}}" class="img-fluid rounded-circle" alt="{{Auth::user()->name}}">
                                    </span>
                <span>
              ...
              {{--  <a href="javascript:void(0);" class="dropdown-item notify-item">
               ...
               {{-- <a href="javascript:void(0);" class="dropdown-item notify-item">
                ...
                @php
                    ...
                    $tmpRoute = ($tmp=='admin')?'admin.logout':'logout';
                @endphp

                <form id="logout-form" action="@auth($tmp){{ route($tmpRoute) }} @else {{ route($tmpRoute) }} @endauth" method="POST" class="d-none">
                    @csrf
                </form>
            </div>
        </li>
    ...
    <ul class="list-unstyled topbar-menu float-start mb-0">
        <li class="notification-list">
            <a class="nav-link end-bar-toggle text-body" href="{{route('quotes.new')}}"
               data-bs-html="true"
               title="Create Estimate">
                <i class="mdi mdi-plus-circle fs-3 noti-icon"></i>
            </a>
        </li>
        <li class="notification-list">
            <a class="nav-link end-bar-toggle text-body" href="javascript: void(0);" title="Recent Activities">
                <i class="mdi mdi-av-timer fs-3 noti-icon"></i>
            </a>
        </li>
    </ul>
