                                ...
                                <div class="tab-pane show active" id="home1">
                                    <div class="accordion custom-accordion" id="custom-accordion-one">
                                        ...
                                        <div class="card mb-0">
                                                ...
                                                <h5 class="m-0">
                                                    <div class="form-check form-checkbox-dark">
                                                        <input type="checkbox" class="form-check-input"
                                                               ...
                                                               name="pdf_cover_page_flg" checked>
                                            ...
                                            <div id="collapseFour" class="collapse"
                                                ...
                                                <textarea id="est_cover_page_title" name="est_cover_page_title"
                                                          ...
                                                          rows="3"
                                                          placeholder="This textarea has a limit of 225 chars.">{{html_entity_decode($proposal_template->cover_title, ENT_QUOTES, 'UTF-8')}}</textarea>
                                                        </div>
                                                    ...
                                                    <textarea id="est_cover_page_content"
                                                              ...
                                                              class="form-control" maxlength="2048"
                                                              rows="3"
                                                              placeholder="This textarea has a limit of 225 chars.">{!!html_entity_decode($proposal_template->cover_content, ENT_QUOTES, 'UTF-8')!!}
                                                    </textarea>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <textarea id="est_cover_page_footer_one"
                                                              ...
                                                              class="form-control" maxlength="2048"
                                                              rows="3"
                                                              placeholder="This textarea has a limit of 225 chars.">{!!html_entity_decode($proposal_template->cover_footer_one, ENT_QUOTES, 'UTF-8')!!}</textarea>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <textarea id="est_cover_page_footer_two"
                                                              ...
                                                              class="form-control" maxlength="2048"
                                                              rows="3"
                                                              placeholder="This textarea has a limit of 225 chars.">{!! html_entity_decode($proposal_template->cover_footer_two, ENT_QUOTES, 'UTF-8')!!}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane show active"
                                                            ...
                                                            <textarea id="est_aboutus_title"
                                                                      ...
                                                                      class="form-control" maxlength="2048"
                                                                      rows="3"
                                                                      placeholder="This textarea has a limit of 225 chars.">{!! html_entity_decode($proposal_template->aboutas_title, ENT_QUOTES, 'UTF-8')!!}
                                                            </textarea>
                                                        </div>
                                                        <div class="tab-pane" id="aboutus-content-b1">
                                                            <div class="mb-3">
                                                                <textarea id="est_aboutus_content"
                                                                          ...
                                                                          placeholder="This textarea has a limit of 225 chars.">{!! html_entity_decode($proposal_template->aboutas_content, ENT_QUOTES, 'UTF-8')!!}
                                                                </textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                        ...
                                                                        @if($user_list)
                                                                            <select class="form-select" name="user_id"
                                                                                ...
                                                                                @foreach($user_list as $user_list)
                                                                                    <option
                                                                                        value="{{$user_list->id}}">{{$user_list->name}}
                                                                                        - ({{$user_list->email}})
                                                                                    </option>
                                                                                @endforeach
                                                                            </select>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <input type="text" name="tilt" class="form-control" id="tilt" placeholder="Tilt" value="" data-parsley-type="number" data-parsley-trigger="input">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <input type="text" class="form-control" id="no_of_panel" name="no_of_panel" placeholder="No. of panel" value="" data-parsley-type="number" data-parsley-trigger="input">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <input type="text" class="form-control" id="panel_wattage" name="panel_wattage" placeholder="Panel wattage" value="" data-parsley-type="number" data-parsley-trigger="input">
                                                                    </div>
                                                                </div>
                                                            </div> <!-- end row -->
                                                        {{--</div> <!-- end card body-->
                                            ...
                                            <div id="collapseEight" class="collapse"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <textarea id="est_term_condition_title"
                                                              ...
                                                              class="form-control" maxlength="2048"
                                                              rows="3"
                                                              placeholder="This textarea has a limit of 225 chars.">{!! html_entity_decode($proposal_template->terms_title, ENT_QUOTES, 'UTF-8')!!}
                                                    </textarea>
                                                        </div>
                                                        ...
                                                        <textarea id="est_term_condition_content"
                                                                  ...
                                                                  data-toggle="maxlength"
                                                                  class="form-control"
                                                                  maxlength="9216" rows="3"
                                                                  placeholder="This textarea has a limit of 225 chars.">{!! html_entity_decode($proposal_template->terms_content, ENT_QUOTES, 'UTF-8')!!}
                                                        </textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                @if($testimonial_data)
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex">
                                                                            <div class="flex-shrink-0"><img
                                                                                    ...
                                                                                    src="{{Storage::url($testimonial_data->image_one)}}"
                                                                                    alt="Avtar image"></div>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex">
                                                                            <div class="flex-shrink-0"><img
                                                                                    class="rounded-circle avatar-sm"
                                                                                    src="{{Storage::url($testimonial_data->image_two)}}"
                                                                                    alt="Avtar image"></div>
                                                                            <div class="flex-grow-1 ms-2"><a
                                                                                    class="text-secondary"><h5
                                                                                        class="my-1">
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex">
                                                                            <div class="flex-shrink-0"><img
                                                                                    class="rounded-circle avatar-sm"
                                                                                    src="{{Storage::url($testimonial_data->image_three)}}"
                                                                                    alt="Avtar image"></div>
                                                                            <div class="flex-grow-1 ms-2"><a
                                                                                    class="text-secondary"><h5
                                                                                        class="my-1">
                                        ...
                                        <div class="mt-3 text-end">
                                            ...
                                            <button class="btn btn-primary" id="estimate_button"
                                                        ...
                                                        <div class="sub-page">
                                                            @foreach($products as $pk => $product)
                                                                <div class="p-0 row"
                                                                    ...
                                                                    <div class="float-start mb-3" style="text-align: center;">
                                                                        <div
    ...
    <script>
        ...
        function addnewrow() {
            ...
            var tr = '<tr id="' + n + '">' +
                ...
                '<td class="input-group"><input type="text" class="form-control discount" name="data[' + n + '][discount]" id="discount_' + n + '" placeholder="Discount" required="" value="0"> <select class="btn-light discount_flag" id="discount_flag" name="data[' + n + '][discount_flag]"><option value="1">%</option><option value="2">₹</option></select></td>' +
