                                                            ...
                                                            <div class="row pt-2">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <table
                                                                        ...
                                                                        <tr style="{{($estimate->customer_state_id==$company_data->state_id)?'': 'display: none'}}">
                                                                            <th>CGST</th>
                                                                            <td>
                                                                                <input type="text"
                                                            ...
                                                            <tr id="1">
                                                                    ...
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="flex-grow-1 ms-2">
                                                                            <a class="text-secondary"><h5 class="my-1">
                                                                                    {{$testimonials->client_name_one}}</h5></a>
                                                                            <p class="text-muted mb-0">{{$testimonials->rating_one}} <span
                                                                                    class="text-warning mdi mdi-star"></span></p>
                                                                        </div>
                                                                    </div>
                                                                <td>
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="flex-grow-1 ms-2">
                                                                            <a class="text-secondary"><h5 class="my-1">
                                                                                    {{$testimonials->client_name_two}}</h5></a>
                                                                            <p class="text-muted mb-0">{{$testimonials->rating_two}} <span
                                                                                    class="text-warning mdi mdi-star"></span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="flex-grow-1 ms-2">
                                                                            <a class="text-secondary"><h5 class="my-1">
                                                                                    {{$testimonials->client_name_three}}</h5></a>
                                                                            <p class="text-muted mb-0">{{$testimonials->rating_three}} <span
                                                                                    class="text-warning mdi mdi-star"></span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                ...
                <div class="modal-body">
                    <form class="ps-3 pe-3 testimonial-form" id="testimonial-form" action="#"
                        ...
                        <table class="table table-sm mb-0">
                            ...
                            <tr id="1">
                                <td>
                                    <input class="form-control" type="text" id="client_name_one" name="client_name_one" required="" placeholder="Enter name" autofocus>
                                </td>
                                <td>
                                    <textarea class="form-control" id="description_one" name="description_one" placeholder="Enter description" maxlength="225" data-toggle="maxlength" required=""></textarea>
                                </td>
                                <td>
                            ...
                            <tr id="3">
                                <td>
                                    <input class="form-control" type="text" id="client_name_three" name="client_name_three"
                                           required=""
                                           placeholder="Enter name" autofocus>
...
*/
            ...
            getDivValThemeEstimate('{{$proposal_template->theme_color_two}}')
            ...
            $('.estimate-form').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    complete: function (data) {
                        $("#estimate_button").html('Save');
                        $("#estimate_button").prop('<i class="uil-arrow-circle-right"></i> disabled', false);
                    }
                });
                // }
            });
