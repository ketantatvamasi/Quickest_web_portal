...
@section('content')
    ...
    <x-breadcrumbs pagename="USERS" pagetitle="ADD_USER"/>
    <div class="card">
        <div class="card-body">
                ...
                <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="user_id" name="user_id" >
                                ...
                                @foreach($user_list as $user_list)
                                    <option value="{{$user_list->id}}">{{$user_list->name}} - ({{$user_list->email}})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" id="email" name="email" class="form-control" placeholder="Email" required>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="mb-3">
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input id="pincode" type="text" class="form-control" name="pincode" placeholder="Enter your pincode" required>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="mb-3">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mt-3">
                                            <div class="form-check">
                                                <input type="checkbox" name="data[{{$key}}][permission_id]" value="{{$permission->id}}" class="form-check-input" id="customCheck{{$permission->name}}">
