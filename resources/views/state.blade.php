        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    @if(in_array('add-state', $user_perm) || auth()->user()->company_id==null)
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            return '<div class="invoice-action">' +
                                @if(in_array("edit-state", $user_perm) || auth()->user()->company_id==null)
                                    '<a href="javascript:void(0)" class="action-icon mr-1" id="edit_' + row.action + '" onclick="' + edit_fun + '">' +
                                    '<i class="mdi mdi-square-edit-outline"></i>' +
                                    '</a>'+
                                @endif
                                @if(in_array("remove-state", $user_perm) || auth()->user()->company_id==null)
