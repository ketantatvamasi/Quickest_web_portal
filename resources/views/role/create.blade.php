@extends('layouts.app')
@section('title',Config::get('constants.ADD_ROLE'))
@push('styles')
@endpush
@section('content')
    <x-breadcrumbs pagename="ROLE" pagetitle="ADD_ROLE"/>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form class="forms-sample role-form" id="role-form" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-4">
                        ...
                        <button type="submit" class="btn btn-primary float-end" id="role_button">{{ __('Submit') }}</button>
                    </form>
                </div>
            </div>
        </div>
