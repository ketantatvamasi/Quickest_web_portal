        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <?php if(in_array('add-product', $user_perm) || auth()->user()->company_id==null){  ?>
